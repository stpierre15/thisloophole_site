...
Initial supported types: phones, cameras, chairs, drills and watches. The deterministic identity normalizer recognizes selected Apple, Sony, Herman Miller, Makita and Garmin models. Unknown types require a more specific supported query. Curated generation mappings are Sony A7 IV → A7 III and Apple iPhone 16 Pro → iPhone 15 Pro; they are not generated for arbitrary products. Manufacturer links support reviewing differences.
