...
import { estimateFiveYearCost } from './dealership-cost.mjs';
...
export function blindCar(candidate,sessionId) {
  ...
  return {
    ...
    bodyStyle:shopperBodyStyle(car),price:car.startingMSRP,priceIsModelBase:!!car.priceIsModelBase,fiveYearCost:estimateFiveYearCost(car),powertrain:car.powertrain,fuelType:car.fuelType,seats:availableSeats(car),seatingVaries:!!seating&&availableSeats(car)!==car.seats,
