...
export const sizeLimits = Object.freeze({ small: [185, 73], medium: [195, 76], large: [210, 82], any: [Infinity, Infinity] });
const choices = {
...
function score(car,a) {
  ...
  add(a.weather!=='no' && car.awdAvailable === true,5,'AWD available');
