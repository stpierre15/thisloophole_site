...
function sortedCandidates(data,candidates){
 ...
 rows.sort((a,b)=>{
  const value=car=>key==='cost'?car.fiveYearCost?.total:key==='mile'?car.fiveYearCost?.costPerMile:car[field];
